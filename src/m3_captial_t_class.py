...
class CapitalT(object):
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        t1 = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(), self.v_rect.get_height(),
                      self.h_rect.get_height())
        outline = self.h_rect.fill_color
        thickness = self.v_rect.outline_color
        t1.set_colors(outline, thickness)
        return t1
